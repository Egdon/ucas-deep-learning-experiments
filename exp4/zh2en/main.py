...
from utils import chinese_tokenizer_load  # 中译英：源语言使用中文分词器

# 添加模型路径
sys.path.append('../model')
from model.transformer import make_model, LabelSmoothing
...
def translate_example():
    """翻译示例 - 中译英"""
    sent = "近期的政策对策很明确：把最低工资提升到足以一个全职工人及其家庭免于贫困的水平，扩大对无子女劳动者的工资所得税减免。"
    
    print("原文:", sent)
    print("参考译文: The near-term policy remedies are clear: raise the minimum wage to a level that will keep a fully employed worker and his or her family out of poverty, and extend the earned-income tax credit to childless workers.")
